...
class track():
    ...
    def stir_salad(self,stir_joint_angles):
        ...
        for i in range(10000):
            current_pose.pose.position.y = initial_y + math.sin(i*0.002)*0.1
            current_pose.pose.position.x = initial_x - (0.1-math.cos(i*0.002)*0.1)
...
def ik_move(hdr, arm, kin, target_dx = None, target_dy = None, target_dz = None, x = None, y = None, z = None, timeout= 50000,speed = 1.0, speedx = 1.0,speedy = 1.0,speedz = 1.0):
